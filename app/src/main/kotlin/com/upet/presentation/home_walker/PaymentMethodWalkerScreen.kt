...
@Composable
fun PaymentMethodWalkerCard(
    method: WalkerPaymentMethodDto,
...
@Composable
fun PaymentMethodsWalkerScreen(
    onNavigateBack: () -> Unit,
    onAddMethod: () -> Unit,
    viewModel: PaymentMethodsWalkerViewModel = hiltViewModel()
) {
